...
class EnquiryCreate(BaseModel):
    ...
    director_names: Optional[List[str]] = Field(default_factory=list)  # FIX #20: was mutable default []
    shareholder_names: Optional[List[str]] = Field(default_factory=list)
    shareholding_pattern: Optional[Dict[str, float]] = Field(default_factory=dict)  # FIX #20: was mutable default {}
