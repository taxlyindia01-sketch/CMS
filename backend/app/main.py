...
import os as _os
_ALLOWED_METHODS = _os.getenv("ALLOWED_METHODS", "GET,POST,PATCH,PUT,DELETE,OPTIONS").split(",")
_ALLOWED_HEADERS = _os.getenv("ALLOWED_HEADERS", "Content-Type,Authorization,X-Requested-With").split(",")

app.add_middleware(
    CORSMiddleware,
    allow_origins=_ALLOWED_ORIGINS,
    allow_credentials=True,
    # FIX #21: Scoped to specific methods/headers instead of wildcard "*"
    # Override via ALLOWED_METHODS / ALLOWED_HEADERS env vars if needed
